...
def big_dt_function(tradeone,basetime):
    ...
    # 整体处理 #直接 1000就好
    # 求一个平均差即可！如果！
    the_last_dt_88888 = ticks_frame.tail(88888)
    the_last_row = the_last_dt_88888.tail(1)
    ...
    the_first_row_basetime = the_last_dt_88888.loc[the_last_dt_88888['time'] == "{0}".format(_base_time)]
    the_first_row_basetime_minus1 = the_last_dt_88888.loc[the_last_dt_88888['time'] == "{0}".format(_base_time_minus1)]
    the_first_row_basetime_minus2 = the_last_dt_88888.loc[the_last_dt_88888['time'] == "{0}".format(_base_time_minus2)]
    the_first_row_basetime_minus3 = the_last_dt_88888.loc[the_last_dt_88888['time'] == "{0}".format(_base_time_minus3)]
...
def final_(tradeone):
    ...
    find_and_confirm_signal(tradeone, float(confirm_dt_5), float(confirm_dt_60), FX_trade_dict, 0.33, 0.13)
